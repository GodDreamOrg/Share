package com.mk.share.order.service.httpunit;
 ...
 *
 * @author wanghao
 * @create 2017-08-11 11:08
 */
public class HttpUnitTest {
    public static void main(String[] args) {
        try {
            HttpUnitTest.testGetHtmlContent("https://www.taobao.com");
...
//            HttpUnitTest.testFormSubmit();
    ...
    public static void testGetHtmlContent(String url) throws IOException, SAXException {
        ...
        WebImage[] webImages = wr.getImages();
